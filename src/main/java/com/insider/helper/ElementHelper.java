...
public class ElementHelper {
    ...
    private void waitForMilliseconds(int milliseconds) {
        ...
        /**
     * Finds and returns WebElement by element name from locators.json
    ...
    public WebElement findElement(String elementName) {
        try {
            ...
            String error = String.format("✗ Failed to find element '%s': %s", elementName, e.getMessage());
            System.err.println(error);
            throw new RuntimeException(error, e);
        }
    }

    public void actionChainClick(WebElement element) {
